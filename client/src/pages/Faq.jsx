...
const Faq = () => {
    const faqs = [
        {
            question: "What is NoteHive?",
            answer:
                "NoteHive is an online platform designed to facilitate the sharing and access of educational resources among college students. It allows users to upload and download study materials such as notes, presentations, and study guides.",
        },
        {
            question: "How do I get started with NoteHive?",
            answer:
        ...
        {
            question: "Is NoteHive free to use?",
            answer:
                "Yes, NoteHive is free to use. We believe in making education accessible to everyone, and our platform is open to all students without any subscription fees.",
        },
        {
            question: "Are my documents secure on NoteHive?",
            answer:
                "Absolutely. We prioritize the security and privacy of your documents. NoteHive employs advanced encryption and security measures to ensure the confidentiality of your uploaded materials.",
        },
        {
            question: "Can I upload any type of document on NoteHive?",
            answer:
        ...
        {
            question: "How can I search for specific study materials on NoteHive?",
            answer:
        ...
        {
            question:
                "Can I collaborate with other students on projects using NoteHive?",
            answer:
                ...
                <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3'>
                    {faqs.map((item, i) => (
                        <div key={i} className=''>
                            ...
                            <p className='border-b pb-2 text-sm text-gray-700 sm:text-base'>{item.answer}</p>
                        </div>
                    ))}
                </div>
            </div>
